...
date: "2026-04-01"
published: true
keywords: ["riba", "Islamic finance", "usury", "fiat currency", "ribawi characteristics", "Riba al-Nasiah", "Qard", "Dayn", "Bay'", "Maqasid al-Shariah", "Hifz al-Mal", "Islamic economics", "Islamic finance GCC", "Islamic finance Malaysia", "Islamic finance UK", "Islamic finance USA"]
---
...
- **Dayn** (the outstanding obligation): shares its root with Din (faith) and Dayyan (Allah the Judge). A Dayn that grows through delay is [Riba al-Nasiah](/blog/rethinking-riba-in-the-age-of-fiat).
...
**Part IX** examines the [Maqasid al-Shariah](/blog/islamic-finance-have-we-avoided-a-sin) (objectives of the law) and the fiat medium, focusing on Hifz al-Mal (preservation of wealth) and whether the fiat system itself constitutes a structural violation of this objective.
...
This research is the foundation on which [the Mizan diagnostic tool](/tools/mizan) was built. Mizan takes the four-word framework established here (Riba, Qard, Dayn, Bay') and the [seven Ribawi characteristics](/blog/introducing-mizan), and applies them as structured diagnostic questions to any financial arrangement.
