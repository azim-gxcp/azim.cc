...
published: true
summary:
  - "Banking reduces to a few original jobs: safekeeping, holding the ledger, and standing in the middle to settle payment across distance."
  - "A public blockchain is one global published ledger and rulebook that can hold value, settle payments directly, and enforce the same rules for everyone, which retires the safekeeping and intermediary roles."
  - "Judging whether wealth is lawful was never a bank's job; it belongs to open law and courts, not a private counter that can withhold your own money."
  - "Once the ledger is the vault and the rail is the settler, what remains is service, best offered by competing financial service providers you can leave at will rather than a bank that holds your wallet."
