...
date: "2026-01-02"
published: true
keywords: ["Islamic finance", "riba", "Shariah compliance", "maqasid al-shariah", "Islamic banking", "murabaha", "musharakah", "mudarabah", "tawarruq", "hiyal", "risk-shifting", "zakat", "Islamic finance GCC", "Islamic finance Malaysia", "Islamic finance UK", "Islamic finance USA"]
---
...
But it has almost completely ignored the ethical imperative of the first. When a person in dire need of funds for medical care or housing is offered a complex *Tawarruq* ([commodity murabaha](/blog/a-response-to-miftah-ismail-on-islamic-banking)) transaction, a series of sales designed to synthetically generate liquidity at a markup, are we not engaging in a business transaction with someone who is in no position to do business? Are we not, in substance, exploiting their need, even if the form is technically a "sale"?
...
At an individual level, IFIs provide a "halal" alternative, which is commendable. But at a societal level, the religion's core economic tenet is justice, not legal acrobatics. The widespread use of [legal fictions](/blog/first-principles-not-compliance) (*hiyal*) to replicate conventional loans erodes the ethical foundation and spirit of the law, promoting a checklist Islam over a substantive one.
